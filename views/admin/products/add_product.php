    ...
    <div class="container border border-3 w-25 ">
        <form action="store.php" method="Post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" value="<?php if (isset($old_data['price'])) echo $old_data['price']; ?>" name='price' id="exampleInputprice1" aria-describedby="priceHelp">
